...
APP_ID = "cli_9f52e124ac2d100b"
APP_SECRET = "RFHFNmIAcA4TW0YpSXZKvggbTfggqK5W"
APP_VERIFICATION_TOKEN = "oxI1tHJ7Kwnz7AKwKKxgOh0OQSWTTrBa"
...
class RequestHandler(BaseHTTPRequestHandler):
    ...
    def handle_message(self, event):
        ...
        d = feedparser.parse(database[event.get("text")])
        datas = []
        for i in d["entries"]:
