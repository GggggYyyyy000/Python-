...
ax.set_title("Guangdong's new crown epidemic growth, cure, and mortality changes")
...
ax2.set_title("Guangdong's new crown epidemic growth, cure, and mortality changes")
...
ax3.set_title("Trend of diagnosis and cure of new crown patients in Guangdong")
ax3.set_xlabel('Days of COVID-19 Outbreak')
ax3.set_ylabel('Number of people')
#plt.axvline(x=3,ls="--",c="#eceae8")
#plt.axvline(x=71,ls="--",c="#eceae8")
plt.savefig('广东省疫情暴发趋势统计.jpg') 
plt.show()
