...
ax.set_title("Shenzhen's new crown epidemic growth, cure, and mortality changes")
...
ax2.set_title("Shenzhen's new crown epidemic growth, cure, and mortality changes")
...
ax3.set_title("Trend of diagnosis and cure of new crown patients in Shenzhen")
ax3.set_xlabel('Days of COVID-19 Outbreak')
ax3.set_ylabel('Number of people')

plt.savefig('深圳疫情暴发趋势统计.jpg') 
plt.show()
