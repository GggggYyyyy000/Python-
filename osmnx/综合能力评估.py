...
amenities = ['safeguard','heal','protect']
distance = 1000
num_pois = 10
...
poi_filename = 'D:\\python\\osmnx\\Data\\all.csv'
...
ax.set_axis_bgcolor(bgcolor)
ax.set_title('Evaluation of Shenzhen current epidemic prevention capabilities', fontsize=15)
fig.savefig('D:\\python\\osmnx\\images\\epidemic-prevention-capabilities.png', dpi=200, bbox_inches='tight')

bmap, fig, ax = network.plot(all_access[1], bbox=bbox, plot_type='hexbin', plot_kwargs=hex_plot_kwargs, 
                             fig_kwargs=fig_kwargs, bmap_kwargs=bmap_kwargs, cbar_kwargs=cbar_kwargs)
ax.set_axis_bgcolor(bgcolor)
ax.set_title('Evaluation of Shenzhen current epidemic prevention capabilities', fontsize=15)
fig.savefig('D:\\python\\osmnx\\images\\epidemic-prevention-capabilities-Hexagon.png', dpi=200, bbox_inches='tight')
